...
module YEA
  module MESSAGE
    ...
    TEXT_SKIP = :Z     # Input::A is the shift button on keyboard.
    ...
    #=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
    NAME_WINDOW_X_BUFFER = 188     # Buffer x position of the name window.
    NAME_WINDOW_Y_BUFFER = 41       # Buffer y position of the name window.
    NAME_WINDOW_PADDING  = 12      # Padding added to the horizontal position.
    ...
    MESSAGE_WINDOW_FONT_NAME = ["EB Garamond 08 Standard Digit"]
...
class Game_Interpreter
  ...
  def command_101
    ...
    # if @params[2] == 0 && @params[3] == 2
    #   if @list[@index+1] && @list[@index+1].parameters[0].include?("\\bm")
    #     $game_message.background = 0
    #   else
    #     $game_message.background = 2
    #     if screen.pictures[30].name != "Message Box"
    #       screen.pictures[30].show("Message Box", 0, 0, 189, 100, 100, 0, 0)
    #       screen.pictures[30].move(0, 0, 189, 100, 100, 255, 0, 12)
    #     end
    #   end
    # end
    ...
    wait_for_message
    # if @params[2] == 0 && @params[3] == 2 && next_event_code != 101
    #   screen.pictures[30].move(0, 0, 189, 100, 100, 0, 0, 12)
    #   wait(12)
    #   screen.pictures[30].erase
    # end
  end
